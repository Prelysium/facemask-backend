...
class CentroidTracker:
    ...
    Attributes:
        nextObjectId (int): Incremental counter for objects
        objects (dict): Dictionary of ID:centroid pairs
    ...
    def __init__(self, maxDisappeared=50):
        """
        Args:
            maxDissapeared (int): Number of consecutive missed frames
                to assume it dissapeared
        """
    ...
    def update(self, rects):
        ...
        Returns:
            (list): Updated list of trackable objects
        """
